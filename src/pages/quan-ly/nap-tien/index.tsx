          ...
          <div className="pt-8">
              ...
              <ul className="divide-y  border-2">
                <li className=" px-2.5 py-2.5  flex">
                  <Link href="" className="basis-64 basis-2">
                    <a className=" ">
                      <Image src={'/images/bank-transfer.png'} width ={80} height ={64}alt=""  />
                    </a>
                  </Link>
                ...
                <li className="  px-2.5 py-2.5  flex">
                  <Link href="" className="basis-64 basis-2">
                    <a className="">
                      <Image src={'/images/payment-method.svg'} width ={80} height ={64}alt=""  />
                    </a>
                  </Link>
                  <Link href="" className="basis-32 basis-0">
                ...
                <li className="   px-2.5 py-2.5 flex">
                  <Link href="" className="basis-64 basis-2">
                    <a className="">
                      <Image src={'/images/zalopay.png'} width ={64} height ={64}alt=""  />
                ...
                <li className="   px-2.5 py-2.5 flex">
                  <Link href="" className="basis-64 basis-2">
                    <a className="">
                      <Image src={'/images/cash.svg'} width ={80} height ={64}alt=""  />
                ...
                <li className="   px-2.5 py-2.5 flex">
                  <Link href="" className="basis-64 basis-2">
                    <a className="">
                      <Image src={'/images/momo.png'} width ={64} height ={64}alt=""  />
            ...
            <div className=" grid grid-cols-3 text-center  gap-6  py-7 s:hidden xs:hidden 2xs:hidden 3xs:hidden  ">
                ...
                <div className=" border-2 hover:border-x-blue-300 hover:border-y-teal-300  ">
                 ...
                 <Link href="" >
                    <a >
                      <Image src={'/images/momo.png'} width ={80} height ={80}alt=""  />
                    </a>
                  </Link>
                 </div>
                ...
                <div className=" border-2 hover:border-x-blue-300 hover:border-y-teal-300  ">
                 ...
                 <Link href="" >
                    <a >
                      <Image src={'/images/zalopay.png'} width ={80} height ={80}alt=""  />
                ...
                <div className=" border-2 hover:border-x-blue-300 hover:border-y-teal-300  ">
                 ...
                 <Link href="" >
                    <a >
                      <Image src={'/images/cash.svg'} width ={64} height ={64}alt=""  />
                ...
                <div className=" border-2 hover:border-x-blue-300 hover:border-y-teal-300  ">
                 ...
                 <Link href="" >
                    <a >
                      <Image src={'/images/payment-method.svg'} width ={64} height ={64}alt=""  />
